      ...
      (e) =>
        ...
        ((e) => {
          ...
          return null === e
            ...
            ? 'array'
            : 'object' === t && ((n = o = e), (r = String).prototype.isPrototypeOf(n) || (null === (a = o.constructor) || void 0 === a ? void 0 : a.name) === r.name)
            ? 'string'
            : t
          var n, o, r, a
        })(e))
    ...
    m = (e, t) => {
      ...
      const m = d.getRng(),
        ...
        { container: p, offset: y } = ((e, t) => {
          let n = e,
            o = t
          for (; 1 === n.nodeType && n.childNodes[o]; ) (n = n.childNodes[o]), (o = 3 === n.nodeType ? n.data.length : n.childNodes.length)
