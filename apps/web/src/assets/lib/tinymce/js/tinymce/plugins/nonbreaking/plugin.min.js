...
!(function () {
  ...
  n.add('nonbreaking', (n) => {
    ;((n) => {
      ...
      e('nonbreaking_force_tab', { processor: (n) => (o(n) ? { value: n ? 3 : 0, valid: !0 } : a(n) ? { value: n, valid: !0 } : { valid: !1, message: 'Must be a boolean or number.' }), default: !1 }),
      ...
      ((n) => {
        ...
        n.ui.registry.addButton('nonbreaking', { icon: 'non-breaking', tooltip: 'Nonbreaking space', onAction: e, onSetup: u(n) }),
          n.ui.registry.addMenuItem('nonbreaking', { icon: 'non-breaking', text: 'Nonbreaking space', onAction: e, onSetup: u(n) })
      })(n),
      ((n) => {
        const e = i(n)
        e > 0 &&
