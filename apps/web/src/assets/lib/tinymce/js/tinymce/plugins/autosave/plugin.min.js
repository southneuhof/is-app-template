    ...
    (t) =>
      ...
      ((t) => {
        ...
        return null === t
          ...
          ? 'array'
          : 'object' === e && ((r = o = t), (a = String).prototype.isPrototypeOf(r) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === a.name)
          ? 'string'
          : e
        var r, o, a, s
      })(t))
  ...
  t.add(
    ...
    (t) => (
      ...
      ((t) => {
        ...
        t.ui.registry.addButton('restoredraft', { tooltip: 'Restore last draft', icon: 'restore-draft', onAction: e, onSetup: h(t) }),
          t.ui.registry.addMenuItem('restoredraft', { text: 'Restore last draft', icon: 'restore-draft', onAction: e, onSetup: h(t) })
      })(t),
      t.on('init', () => {
        l(t) && t.dom.isEmpty(t.getBody()) && y(t)
      }),
      ((t) => ({ hasDraft: () => f(t), storeDraft: () => g(t), restoreDraft: () => y(t), removeDraft: (e) => p(t, e), isEmpty: (e) => v(t, e) }))(t)
    )
  )
})()
