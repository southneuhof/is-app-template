...
!(function () {
  ...
  const t = (e) => (t) =>
      ((e) => {
        ...
        return null === e
          ...
          ? 'array'
          : 'object' === t && ((s = r = e), (o = String).prototype.isPrototypeOf(s) || (null === (n = r.constructor) || void 0 === n ? void 0 : n.name) === o.name)
          ? 'string'
          : t
        var s, r, o, n
      })(t) === e,
  ...
  const p = (e) => (t) => t.options.get(e),
    ...
    S = (e, t) => {
      ...
      return (
        r[1]
          ? ((s = { title: t }), e.schema.getTextBlockElements()[o] ? (s.block = o) : e.schema.getBlockElements()[o] || c[o.toLowerCase()] ? (s.selector = o) : (s.inline = o))
