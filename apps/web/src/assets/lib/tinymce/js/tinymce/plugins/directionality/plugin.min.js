...
!(function () {
    ...
    o = (t) =>
      ...
      ((t) => {
        ...
        return null === t
          ...
          ? 'array'
          : 'object' === e && ((o = r = t), (n = String).prototype.isPrototypeOf(o) || (null === (i = r.constructor) || void 0 === i ? void 0 : i.name) === n.name)
          ? 'string'
          : e
        var o, r, n, i
      })(t),
  ...
  const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
    ...
    w = i(Element.prototype.attachShadow) && i(Node.prototype.getRootNode) ? (t) => d(t.dom.getRootNode()) : (t) => (v(t) ? t : d(t.dom.ownerDocument)),
    b = (t) => d(t.dom.host),
    N = (t) => {
    ...
    S = (t) =>
      ...
      ((t, e) => {
        ...
        return '' !== r || N(t) ? r : ((t, e) => (((t) => void 0 !== t.style && i(t.style.getPropertyValue))(t) ? t.style.getPropertyValue(e) : ''))(o, e)
      })(t, 'direction')
        ? 'rtl'
        : 'ltr',
    A = (t, e) =>
  ...
  t.add('directionality', (t) => {
    ;((t) => {
      ...
      ((t) => {
        t.ui.registry.addToggleButton('ltr', { tooltip: 'Left to right', icon: 'ltr', onAction: () => t.execCommand('mceDirectionLTR'), onSetup: D(t, 'ltr') }),
          t.ui.registry.addToggleButton('rtl', { tooltip: 'Right to left', icon: 'rtl', onAction: () => t.execCommand('mceDirectionRTL'), onSetup: D(t, 'rtl') })
      })(t)
  })
})()
