...
!(function () {
      ...
      (e) =>
        ...
        ((e) => {
          ...
          return null === e
            ...
            ? 'array'
            : 'object' === t && ((n = a = e), (r = String).prototype.isPrototypeOf(n) || (null === (o = a.constructor) || void 0 === o ? void 0 : o.name) === r.name)
            ? 'string'
            : t
          var n, a, r, o
        })(e))
        ...
        n = (e, n) => {
          ...
          ((e, t, n) => {
            ...
            (e) => {
              ...
              return { name: n, html: t({ name: n, url: `https://www.tiny.cloud/docs/tinymce/7/${e.slug}/` }) }
            }
          )
          var a, r
        },
    ...
    ;(async (e, t, a) => {
      const o = _(),
        ...
        m = (() => {
          ...
          return { name: 'versions', title: 'Version', items: [{ type: 'htmlpanel', html: '<p>' + f.translate(['You are using {0}', n]) + '</p>', presets: 'document' }] }
        })(),
  ...
  e.add('help', (e, t) => {
    ...
    return (
      ((e, t) => {
        e.ui.registry.addButton('help', { icon: 'help', tooltip: 'Help', onAction: t }), e.ui.registry.addMenuItem('help', { text: 'Help', icon: 'help', shortcut: 'Alt+0', onAction: t })
      })(e, o),
      ((e, t) => {
