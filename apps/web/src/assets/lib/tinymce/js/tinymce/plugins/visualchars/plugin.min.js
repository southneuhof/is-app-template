...
!(function () {
  ...
  const e = (t) => (e) =>
      ((t) => {
        ...
        return null === t
          ...
          ? 'array'
          : 'object' === e && ((n = o = t), (r = String).prototype.isPrototypeOf(n) || (null === (s = o.constructor) || void 0 === s ? void 0 : s.name) === r.name)
          ? 'string'
          : e
        var n, o, r, s
      })(e) === t,
  ...
  const u = (t, e) => {
    ...
    A = (t, e, n) => {
      ;((t, e, n) => {
        if (!(o(n) || a(n) || l(n))) throw (console.error('Invalid call to Attribute.set. Key ', e, ':: Value ', n, ':: Element ', t), new Error('Attribute value was not simple'))
        t.setAttribute(e, n + '')
      })(t.dom, e, n)
    },
    k = (t, e) => {
  ...
  t.add('visualchars', (t) => {
    ...
    return (
      ...
      ((t, e) => {
        ...
        t.ui.registry.addToggleButton('visualchars', { tooltip: 'Show invisible characters', icon: 'visualchars', onAction: n, onSetup: U(t, e) }),
          t.ui.registry.addToggleMenuItem('visualchars', { text: 'Show invisible characters', icon: 'visualchars', onAction: n, onSetup: U(t, e) })
      })(t, e),
      R(t, e),
      ((t, e) => {
        t.on('init', () => {
