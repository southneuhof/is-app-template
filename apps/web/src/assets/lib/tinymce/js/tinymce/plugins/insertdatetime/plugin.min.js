...
!(function () {
  ...
  const t = (e) => (t) => t.options.get(e),
    ...
    d = (e, t, a = new Date()) =>
      (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = t.replace('%D', '%m/%d/%Y')).replace('%r', '%I:%M:%S %p')).replace('%Y', '' + a.getFullYear())).replace(
        '%y',
        '' + a.getYear()
      )).replace('%m', c(a.getMonth() + 1, 2))).replace('%d', c(a.getDate(), 2))).replace('%H', '' + c(a.getHours(), 2))).replace('%M', '' + c(a.getMinutes(), 2))).replace(
        '%S',
        '' + c(a.getSeconds(), 2)
      )).replace('%I', '' + (((a.getHours() + 11) % 12) + 1))).replace('%p', a.getHours() < 12 ? 'AM' : 'PM')).replace('%B', '' + e.translate(m[a.getMonth()]))).replace(
        '%b',
        '' + e.translate(l[a.getMonth()])
      )).replace('%A', '' + e.translate(o[a.getDay()]))).replace('%a', '' + e.translate(i[a.getDay()]))).replace('%%', '%'),
    u = (e, t) => {
      if (s(e)) {
        const a = d(e, t)
        let n
