      ...
      (t) =>
        ...
        ((t) => {
          ...
          return null === t
            ...
            ? 'array'
            : 'object' === e && ((o = n = t), (r = String).prototype.isPrototypeOf(o) || (null === (i = n.constructor) || void 0 === i ? void 0 : i.name) === r.name)
            ? 'string'
            : e
          var o, n, r, i
        })(t))
        ...
        onAction: () => {
          ;((t) =>
            new Promise((e) => {
              ...
              ;(n.type = 'file'), (n.accept = 'image/*'), (n.style.position = 'fixed'), (n.style.left = '0'), (n.style.top = '0'), (n.style.opacity = '0.001'), document.body.appendChild(n)
              const r = (t) => {
                  var r
          ...
          predicate: (e) => {
            ...
            return (
              ...
              ((t, e, o) => h((t, e) => v(t, e), y, t, 'table,[data-mce-bogus="all"]', o))(o, 0, r).fold(
                () => ((t, e, o) => ((t, e, o) => h((t, e) => e(t), f, t, e, o))(t, e, o).isSome())(o, (e) => e.dom.nodeName.toLowerCase() in n && t.dom.isEmpty(e.dom), r),
                m
              )
            )
          },
  ...
  t.add('quickbars', (t) => {
    ;((t) => {
      const e = t.options.register,
        r = (t) => (e) => {
          const r = n(e) || o(e)
          return r ? (n(e) ? { value: e ? t : '', valid: r } : { value: e.trim(), valid: r }) : { valid: !1, message: 'Must be a boolean or string.' }
        },
      ...
      ((t) => {
        ...
        const r = s(t)
        r.length > 0 && t.ui.registry.addContextToolbar('textselection', { predicate: (n) => !o(n) && !t.selection.isCollapsed() && e(n), items: r, position: 'selection', scope: 'editor' })
      })(t)
  })
})()
