...
!(function () {
  ...
  const t = (e) => (t) =>
      ((e) => {
        ...
        return null === e
          ...
          ? 'array'
          : 'object' === t && ((o = n = e), (r = String).prototype.isPrototypeOf(o) || (null === (s = n.constructor) || void 0 === s ? void 0 : s.name) === r.name)
          ? 'string'
          : t
        var o, n, r, s
      })(t) === e,
  ...
  const ft = (e, t, o) => {
    ...
    so = (e) => (t) => St(t, e),
    lo = [
      { name: 'Edge', versionRegexes: [/.*?edge\/ ?([0-9]+)\.([0-9]+)$/], search: (e) => St(e, 'edge/') && St(e, 'chrome') && St(e, 'safari') && St(e, 'applewebkit') },
      { name: 'Chromium', brand: 'Chromium', versionRegexes: [/.*?chrome\/([0-9]+)\.([0-9]+).*/, ro], search: (e) => St(e, 'chrome') && !St(e, 'chromeframe') },
      { name: 'IE', versionRegexes: [/.*?msie\ ?([0-9]+)\.([0-9]+).*/, /.*?rv:([0-9]+)\.([0-9]+).*/], search: (e) => St(e, 'msie') || St(e, 'trident') },
      { name: 'Opera', versionRegexes: [ro, /.*?opera\/([0-9]+)\.([0-9]+).*/], search: so('opera') },
      { name: 'Firefox', versionRegexes: [/.*?firefox\/\ ?([0-9]+)\.([0-9]+).*/], search: so('firefox') },
      { name: 'Safari', versionRegexes: [ro, /.*?cpu os ([0-9]+)_([0-9]+).*/], search: (e) => (St(e, 'safari') || St(e, 'mobile/')) && St(e, 'applewebkit') },
    ],
    ao = [
      { name: 'Windows', search: so('win'), versionRegexes: [/.*?windows\ nt\ ?([0-9]+)\.([0-9]+).*/] },
      { name: 'iOS', search: (e) => St(e, 'iphone') || St(e, 'ipad'), versionRegexes: [/.*?version\/\ ?([0-9]+)\.([0-9]+).*/, /.*cpu os ([0-9]+)_([0-9]+).*/, /.*cpu iphone os ([0-9]+)_([0-9]+).*/] },
      { name: 'Android', search: so('android'), versionRegexes: [/.*?android\ ?([0-9]+)\.([0-9]+).*/] },
      { name: 'macOS', search: so('mac os x'), versionRegexes: [/.*?mac\ os\ x\ ?([0-9]+)_([0-9]+).*/] },
    ...
    ho = (e) => {
      const t = e.current,
        o = e.version,
        n = (e) => () => t === e
      return { current: t, version: o, isEdge: n(io), isChromium: n(mo), isIE: n('IE'), isOpera: n(uo), isFirefox: n(fo), isSafari: n(go) }
    },
    ...
    Ro = (e) => {
      const t = e.current,
        o = e.version,
        n = (e) => () => t === e
      return { current: t, version: o, isWindows: n(wo), isiOS: n('iOS'), isAndroid: n(vo), isMacOS: n(xo), isLinux: n(yo), isSolaris: n(Co), isFreeBSD: n(So), isChromeOS: n(To) }
    },
    Do = () => Ro({ current: void 0, version: oo.unknown() }),
    Oo = Ro,
    ko = (g(wo), g('iOS'), g(vo), g(yo), g(xo), g(Co), g(So), g(To), (e) => window.matchMedia(e).matches)
  let Eo = Zt(() =>
    ((e, t, o) => {
      const n = co.browsers(),
        r = co.oses(),
        ...
        a = ((e, t, o, n) => {
          const r = e.isiOS() && !0 === /ipad/i.test(o),
            ...
            d = !i && !c && !m
          return { isiPad: g(r), isiPhone: g(s), isTablet: g(c), isPhone: g(i), isTouch: g(a), isAndroid: e.isAndroid, isiOS: e.isiOS, isWebView: g(m), isDesktop: g(d) }
        })(l, s, e, o)
  ...
  const No = () => Eo(),
    ...
    Wo = (e) =>
      ((e, t) => {
        ...
        return 'border-box' === t ? n : ((e, t, o, n) => t - _o(e, `padding-${o}`, 0) - _o(e, `padding-${n}`, 0) - _o(e, `border-${o}-width`, 0) - _o(e, `border-${n}-width`, 0))(e, n, 'left', 'right')
      })(e, 'content-box'),
    Mo = (e, t, o) => {
      const n = e.cells,
        r = n.slice(0, t),
      ...
      N(c, (e) => {
        ...
        N(e.cells, (e) => {
          ...
          const r = ((e, t) => X(e, t) && void 0 !== e[t] && null !== e[t])(n, o.toString()),
            c = ((e, t, o, n, r, s) => ({ element: e, rowspan: t, colspan: o, row: n, column: r, isLocked: s }))(e.element, e.rowspan, e.colspan, l, o, r)
    ...
    _n = dn({ delta: h, edge: Tn, positions: (e) => Nn(Rn, Dn, e) }, { delta: (e) => -e, edge: Sn, positions: (e) => Nn(Dn, Rn, e) }),
    zn = { delta: (e, t) => _n(t).delta(e, t), positions: (e, t) => _n(t).positions(e, t), edge: (e) => _n(e).edge(e) },
    An = {
    ...
    Kr = (e) => {
      ...
      return t.isSet('table_default_attributes') ? o : ((e, t) => (Vr(e) || Ur(e) ? t : $r(e) ? { ...t, width: Lr(e) } : { ...t, width: Ar }))(e, o)
    },
    ...
    ms = (e, t) => t.column >= e.startCol && t.column + t.colspan - 1 <= e.finishCol && t.row >= e.startRow && t.row + t.rowspan - 1 <= e.finishRow,
    ds = (e, t, o) => {
      const n = tn(e, t, Re),
        r = tn(e, o, Re)
      return n.bind((e) =>
  ...
  const vs = (e, t, o, n) => {
    ...
    xs = ws(),
    Cs = (e, t) => ((e, t, o) => (o.length > 0 ? ((e, t, o, n) => n(e, t, o[0], o.slice(1)))(e, t, o, vs) : C.none()))(xs, (t, o) => e(o), t),
    Ss = (e) => ht(e, 'table'),
    Ts = (e, t, o) => {
    ...
    Ds = (e, t, o) => bt(e, t).bind((t) => bt(e, o).bind((e) => Cs(Ss, [t, e]).map((o) => ({ first: t, last: e, table: o })))),
    Os = (e, t, o, n, r) =>
      ((e, t) => L(e, (e) => Ce(e, t)))(e, r).bind((e) =>
        ((e, t, o) =>
          ...
          ))(e, t, o).bind((e) => ((e, t) => ht(e, 'table').bind((o) => bt(o, t).bind((t) => Ts(t, e).bind((e) => e.boxes.map((t) => ({ boxes: t, start: e.start, finish: e.finish }))))))(e, n))
      ),
    ks = (e, t) => Rs(e, t),
    Es = (e, t, o) =>
      Ds(e, t, o).bind((t) => {
                  ...
                  ((e, t, o) =>
                    ds(e, t, o).bind((t) =>
                      ((e, t) => {
                        let o = !0
                        const n = b(ms, t)
                        for (let r = t.startRow; r <= t.finishRow; r++) for (let s = t.startCol; s <= t.finishCol; s++) o = o && en(e, r, s).exists(n)
    ...
    _s = (e, t, o) => (t.length <= 1 ? C.none() : Es(e, o.firstSelectedSelector, o.lastSelectedSelector).map((e) => ({ bounds: e, cells: t }))),
                ...
                const t = ((e, t) => {
                  const o = (e) => Ce(e.element, t),
                    ...
                    a = ((e, t) => {
                      ...
                      return (
                        ...
                        ((e, t, o, n, r, s) => ({ minRow: e, minCol: t, maxRow: o, maxCol: n, allCells: r, selectedCells: s }))(n, r, s, l, a, c)
                      )
                    })(l, o),
                    c = 'th:not(' + t + '),td:not(' + t + ')',
                  ...
                  N(i, qe),
                    ((e, t, o, n) => {
                      ...
                      for (let e = 0; e < l; e++) {
                        let l = !1
                        for (let a = 0; a < s; a++) e < o.minRow || e > o.maxRow || a < o.minCol || a > o.maxCol || (en(t, e, a).filter(n).isNone() ? fr(r, l, e) : (l = !0))
                      }
                    })(r, l, a, o)
                  const m = ((e, t, o, n) => {
    ...
    qs = (e, t, o) => ((e.property().isText(t) && 0 === e.property().getText(t).trim().length) || e.property().isComment(t) ? o(t).bind((t) => qs(e, t, o).orThunk(() => C.some(t))) : C.none()),
    Us = (e, t) => (e.property().isText(t) ? e.property().getText(t).length : e.property().children(t).length),
    Gs = (e, t) => {
          ...
          Un(e).bind((e) => {
            return (
              ...
              C.from(Ln.exec(t)).bind((e) => {
                const t = Number(e[1]),
                  n = e[2]
                return ((e, t) => O(t, (t) => O(An[t], (t) => e === t)))(n, o) ? C.some({ value: t, unit: n }) : C.none()
              })
            )
            var t, o
          }))(e)
    ...
    cl = (e) => {
      const t = 'thead' === e.section,
        o = vt(il(e.cells), 'th')
      return 'tfoot' === e.section ? { type: 'footer' } : t || o ? { type: 'header', subType: al(t, o) } : { type: 'body' }
    },
    il = (e) => {
        ...
        r = (e) =>
          E(e, (e) => {
            ...
            return (
              Ve(t),
              N(e.cells, (e) => {
                e.isNew && n.push(e.element), vl(e.element, 'colspan', e.colspan, 1), vl(e.element, 'rowspan', e.rowspan, 1), Ie(t, e.element)
              }),
              t
            )
          }),
        ...
        l = (t, o) => {
          const n = ((e, t) => {
              const o = pt(e, t).getOrThunk(() => {
                ...
                return 'thead' === t ? yl(e, 'caption,colgroup', o) : 'colgroup' === t ? yl(e, 'caption', o) : Ie(e, o), o
              })
              return Ve(o), o
            })(e, o),
            l = ('colgroup' === o ? s : r)(t)
        ...
        const s = j(n.cells, (n, s) => {
          if (!1 === o[r][s]) {
            ...
            return (
              ...
              [((l = n.element), (a = m.rowspan), (c = m.colspan), (i = n.isNew), { element: l, rowspan: a, colspan: c, isNew: i })]
            )
          }
          return []
          var l, a, c, i
    ...
    El = (e, t) => Ol(e, t, x).map((e) => ({ cells: e, generators: t.generators, clipboard: t.clipboard })),
    Nl = (e, t) => Ol(e, t, x),
    ...
    $l = (e, t, o, n) => {
      const r = b(n, Fo(e[t], o).element),
        s = e[t]
      return e.length > 1 && $o(s) > 1 && ((o > 0 && r(Ho(s, o - 1))) || (o < s.cells.length - 1 && r(Ho(s, o + 1))) || (t > 0 && r(Ho(e[t - 1], o))) || (t < e.length - 1 && r(Ho(e[t + 1], o))))
    },
      ...
      ;((e, t, o, n) => {
        t > 0 &&
          ...
          N(e, (e) => {
            ...
            let s = 0
            const l = n()
            for (; e.cells.length > t + s && o(r.element, e.cells[t + s].element); ) Po(e, t + s, et(l, !0, e.cells[t + s].isLocked)), s++
          })
      })(t, e, r, n.cell)
      const s = jl(o, t),
        l = Hl(o, s, n),
    ...
    Gl = (e, t, o, n, r) => {
      ...
      return [
        ...l,
        ...a,
        ((e, t, o, n) => qo(e, (e) => n(e, o), t))(s[o], (e, o) => (t > 0 && t < s.length && n(Ho(s[t - 1], o), Ho(s[t], o)) ? Fo(s[t], o) : et(r(e.element, n), !0, e.isLocked)), n, r),
        ...c,
      ]
    },
    Kl = (e, t, o, n, r) =>
    ...
    Yl = (e, t, o, n) => ((e, t, o, n) => void 0 !== Ho(e[t], o) && t > 0 && n(Ho(e[t - 1], o), Ho(e[t], o)))(e, t, o, n) || ((e, t, o) => t > 0 && o(Ho(e, t - 1), Ho(e, t)))(e[t], o, n),
    Jl = (e, t, o, n) => {
      const r = (e) => (((e) => ('row' === e ? ((e) => Mt(e, 'rowspan') > 1)(t) : jt(t)))(e) ? `${e}group` : e)
    ...
    ea = (e, t, o, n, r) => {
      const s = Vo(e).rows,
        l = j(t, (e) => Zl(s, e, n)),
        a = E(s, (e) => ll(e.cells)),
        c = ((e, t) => (P(t, h) && ll(e) ? x : (e, o, n) => !('th' === ne(e.element) && t[o])))(l, a),
        i = (
          (e, t) => (o, n) =>
    ...
    na = { ...oa([{ none: [] }, { only: ['index'] }, { left: ['index', 'next'] }, { middle: ['prev', 'index', 'next'] }, { right: ['prev', 'index'] }]) },
    ra = (e, t, o) => {
      const n = ((e, t) =>
        sn(e)
          ? ((e, t) => {
    ...
    aa = (e) => A(e, (e, t) => (O(e, (e) => e.column === t.column) ? e : e.concat([t])), []).sort((e, t) => e.column - t.column),
    ca = ue('col'),
    ia = ue('colgroup'),
    ma = (e) => 'tr' === ne(e) || ia(e),
      ...
      const t = ue('br'),
        o = (e) =>
          Cr(e)
            .bind((o) => {
              const n = Ae(o)
                .map((e) => !!wa(e) || (!!((e, t) => D(['br', 'img', 'hr', 'input'], e.property().name(t)))(ba, e) && 'img' !== ne(e)))
                .getOr(!1)
              return Ne(o).map((r) => {
                return !0 === n || 'li' === ne((s = r)) || ft(s, va).isSome() || t(o) || (wa(r) && !Re(e, r)) ? [] : [xe.fromTag('br')]
                var s
              })
            })
            .getOr([]),
    ...
    Ra = (e) => A(e, (e, t) => (O(e, (e) => e.row === t.row) ? e : e.concat([t])), []).sort((e, t) => e.row - t.row),
    Da = (e, t) => (o, n, r, s, l) => {
      const a = Ra(n),
        c = E(a, (e) => e.row),
        i = ((e, t, o, n, r, s, l) => {
          ...
          const f = [...a, ...u],
            g = ((e, t) => (P(t, h) && ll(e.cells) ? x : (e, o, n) => !('th' === ne(e.element) && t[n])))(i, d),
            p = (
              (e, t) => (o, n, r) =>
    ...
    Ia = kl(
      (e, t, o, n) => {
        const r = t[0].row,
          s = Ra(t),
          l = z(s, (e, t) => ({ grid: Gl(e.grid, r, t.row + e.delta, o, n.getOrInit), delta: e.delta + 1 }), { grid: e, delta: 0 }).grid
    ...
    Ha = kl(
      (e, t, o, n) => {
        const r = t.details,
          s = aa(r),
          l = s[0].column,
          a = z(s, (e, t) => ({ grid: Kl(e.grid, l, t.column + e.delta, o, n.getOrInit), delta: e.delta + 1 }), { grid: e, delta: 0 }).grid
    ...
    tc = kl(
      (e, t, o, n) => {
        ...
        return ((e, t, o, n, r) => {
          const s = Ko(t),
            ...
            c = Vl(l, a, s),
            i = ((e, t, o) => {
              if (e.row >= t.length || e.column > $o(t[0])) return Wl.error('invalid start address out of table bounds, row: ' + e.row + ', column: ' + e.column)
      ...
      (e, t) => Vt(t.element).bind((o) => Dl(e, o).map((e) => ({ ...e, generators: t.generators, clipboard: t.clipboard }))),
      Ba,
      f,
      fa
    ),
          ...
          (i, m, d = !1) => {
            ...
            return s(i)
              ? n(i, m, f, g).bind((n) => {
                  ...
                  return lt(i) && (ts(i), d || dc(e, i.dom, c)), r.map((e) => ({ rng: e, effect: c }))
                })
              : C.none()
          },
    ...
    xc = { ...vc, from: (e) => (Rt(e, '%') ? yc('%', vc.percent, e) : Rt(e, 'px') ? yc('px', vc.pixels, e) : vc.invalid(e)) },
    Cc = (e, t, o) => {
      const n = xc.from(o),
        r = P(e, (e) => '0px' === e)
          ? ((e, t) => {
    ...
    Lc = { styles: { 'border-collapse': 'collapse', width: '100%' }, attributes: { border: '1' }, colGroups: !1 },
    Wc = (e, t, o, n) =>
      k(e, (e) =>
        ((e, t, o, n) => {
    ...
    jc = (e, t, o, n, s) => {
      const l = ((e) => {
          ...
          return t.isSet('table_default_styles') ? o : ((e, t) => (Vr(e) || !Ur(e) ? t : $r(e) ? { ...t, width: Lr(e) } : { ...t, width: Ar }))(e, o)
        })(e),
      ...
      return (
        ...
        bt(Zr(e), 'table[data-mce-id="__mce"]')
          .map(
            (t) => (
              $r(e) ? zc(t) : Vr(e) ? Ac(t) : (Hr(e) || ((e) => r(e) && -1 !== e.indexOf('%'))(l.width)) && _c(t),
              ts(t),
              we(t, 'data-mce-id'),
              ((e, t) => {
                N(dt(t, 'tr'), (t) => {
  ...
  const Ic = 'x-tinymce/dom-table-',
          ...
          o().each((o) => {
            ...
            l((o, r) => {
              const s = _r(xe.fromDom(e.getDoc())),
                l = ((e, t, o, n) => ({ selection: Ns(e), clipboard: o, generators: n }))(Hs(e), 0, n, s)
              t(o, l).each(a)
            })
          }),
        g = (e) => (t, o) =>
            ...
            ((t) =>
              Xc(e).each((n) => {
                Vr(e) ||
                  ...
                  Hr(e) ||
                  Gt(n, o).each((o) => {
                    'relative' !== t || kc(o) ? ('fixed' !== t || Ec(o) ? 'responsive' !== t || Nc(o) || Ac(o) : zc(o)) : _c(o), ts(o), dc(e, o.dom, fc)
                  })
              }))(n),
    ...
    ti = { before: ei.before, on: ei.on, after: ei.after, cata: (e, t, o, n) => e.fold(t, o, n), getStart: (e) => e.fold(h, h, h) },
    ...
    ci = (e) => ({ left: e.left, top: e.top, right: e.right, bottom: e.bottom, width: e.width, height: e.height }),
    ii = oa([{ ltr: ['start', 'soffset', 'finish', 'foffset'] }, { rtl: ['start', 'soffset', 'finish', 'foffset'] }]),
    mi = (e, t, o) => t(xe.fromDom(o.startContainer), o.startOffset, xe.fromDom(o.endContainer), o.endOffset),
    di = (e, t) => {
      const o = ((e, t) =>
        t.match({
          domRange: (e) => ({ ltr: g(e), rtl: C.none }),
          relative: (t, o) => ({ ltr: Zt(() => li(e, t, o)), rtl: Zt(() => C.some(li(e, o, t))) }),
          exact: (t, o, n, r) => ({ ltr: Zt(() => ai(e, t, o, n, r)), rtl: Zt(() => C.some(ai(e, n, r, t, o))) }),
        }))(e, t)
      return ((e, t) => {
        const o = t.ltr()
        return o.collapsed
          ? t
              ...
              .map((e) => ii.rtl(xe.fromDom(e.endContainer), e.endOffset, xe.fromDom(e.startContainer), e.startOffset))
  ...
  const fi = (e, t, o, n) => ({ start: e, soffset: t, finish: o, foffset: n }),
    ...
    hi = (e, t) => {
      const o = ui(e, t)
      return fi(xe.fromDom(o.startContainer), o.startOffset, xe.fromDom(o.endContainer), o.endOffset)
    },
    pi = gi,
    bi = (e, t, o, n, r) =>
      Re(o, n)
        ...
        : Ts(o, n, t).bind((t) => {
            ...
            return n.length > 1 ? (r(e, n, t.start, t.finish), C.some(oi(C.some(pi(o, 0, o, wr(o))), !0))) : C.none()
          }),
    ...
    Si = (e, t, o, n, r = Ci) => L(r, (e) => e.current === o).bind((o) => o.current(e, t, n, o.next).orThunk(() => o.fallback.bind((o) => Si(e, t, o, n)))),
    Ti = (e, t, o, n, r, s) => Si(e, t, n, r).bind((t) => (s(t.item) ? C.none() : o(t.item) ? C.some(t.item) : Ti(e, t.item, o, t.mode, r, s))),
    Ri = (e) => (t) => 0 === e.property().children(t).length,
    Di = (e, t, o, n) => Ti(e, t, o, yi, { sibling: (e, t) => e.query().prevSibling(t), first: (e) => (e.length > 0 ? C.some(e[e.length - 1]) : C.none()) }, n),
    Oi = (e, t, o, n) => Ti(e, t, o, yi, { sibling: (e, t) => e.query().nextSibling(t), first: (e) => (e.length > 0 ? C.some(e[0]) : C.none()) }, n),
    ki = ws(),
    Ei = (e, t) => ((e, t, o) => Di(e, t, Ri(e), o))(ki, e, t),
    Ni = (e, t) => ((e, t, o) => Oi(e, t, Ri(e), o))(ki, e, t),
    Bi = oa([{ none: ['message'] }, { success: [] }, { failedUp: ['cell'] }, { failedDown: ['cell'] }]),
    _i = (e) => wt(e, 'tr'),
    zi = {
      ...Bi,
    ...
    Ai = ue('br'),
    Li = (e, t, o) => t(e, o).bind((e) => (ie(e) && 0 === hr(e).trim().length ? Li(e, t, o) : C.some(e))),
    Wi = (e, t, o, n) =>
      ((e, t) =>
        We(e, t)
          .filter(Ai)
        ...
        n.traverse(t).fold(
          ...
          (e) =>
            ((e) =>
              Ne(e).bind((t) => {
                const o = Le(t)
                return ((e, t) => W(e, b(Re, t)))(o, e).map((n) => ((e, t, o, n) => ({ parent: e, children: t, element: o, index: n }))(t, o, e, n))
    ...
    Pi = (e, t, o) => ({ left: e.left + t, top: e.top + o, right: e.right + t, bottom: e.bottom + o }),
    Ii = (e) => ({ left: e.left, top: e.top, right: e.right, bottom: e.bottom }),
    Fi = (e, t) => C.some(e.getRect(t)),
    Hi = (e, t, o) =>
      ce(t) ? Fi(e, t).map(Ii) : ie(t) ? ((e, t, o) => (o >= 0 && o < wr(t) ? e.getRangedRect(t, o, t, o + 1) : o > 0 ? e.getRangedRect(t, o - 1, t, o) : C.none()))(e, t, o).map(Ii) : C.none(),
    $i = (e, t) => (ce(t) ? Fi(e, t).map(Ii) : ie(t) ? e.getRangedRect(t, 0, t, wr(t)).map(Ii) : C.none()),
    Vi = oa([{ none: [] }, { retry: ['caret'] }]),
    qi = (e, t, o) => gt(t, wa).fold(y, (t) => $i(e, t).exists((e) => ((e, t) => e.left < t.left || Math.abs(t.right - e.left) < 1 || e.left > t.right)(o, e))),
    Ui = {
      point: (e) => e.bottom,
      adjuster: (e, t, o, n, r) => {
        const s = Mi(r, 5)
        return Math.abs(o.bottom - n.bottom) < 1 || o.top > r.bottom ? Vi.retry(s) : o.top === r.bottom ? Vi.retry(Mi(r, 1)) : qi(e, t, r) ? Vi.retry(Pi(s, 5, 0)) : Vi.none()
      },
      move: Mi,
      gather: Ni,
    },
    ...
    Ki = (e, t, o) => {
      ...
      return ((e, t, o) => (e.point(t) > o.getInnerHeight() ? C.some(e.point(t) - o.getInnerHeight()) : e.point(t) < 0 ? C.some(-e.point(t)) : C.none()))(e, r, t).fold(
    ...
    Yi = {
      tryUp: b(Ki, {
        ...
        adjuster: (e, t, o, n, r) => {
          const s = ji(r, 5)
          return Math.abs(o.top - n.top) < 1 || o.bottom < r.top ? Vi.retry(s) : o.bottom === r.top ? Vi.retry(ji(r, 1)) : qi(e, t, r) ? Vi.retry(Pi(s, 5, 0)) : Vi.none()
        },
        move: ji,
        gather: Ei,
      }),
      ...
      wt(n, 'td,th', t).bind((n) =>
        wt(n, 'table', t).bind((s) =>
          ((e, t) => ft(e, (e) => Ne(e).exists((e) => Re(e, t)), void 0).isSome())(r, s)
            ? ((e, t, o) => Ji(e, t, o).bind((n) => Qi(e, t, n.element, n.offset, o, 20).map(e.fromSitus)))(e, t, o).bind((e) =>
    ...
    rm = (e, t) =>
      wt(e, 'tr', t).bind((e) =>
        wt(e, 'table', t).bind((o) => {
          const n = dt(o, 'tr')
          return Re(e, n[n.length - 1]) ? ((e, t, o) => Oi(ki, e, (e) => xr(e).isSome(), o))(o, 0, t).map((e) => oi(C.some(pi(e, 0, e, 0)), !0)) : C.none()
        })
      ),
    ...
    cm = (e, t) => wt(e, 'td,th', t),
    im = (e) => Be(e).exists(Qr),
    mm = { traverse: Ae, gather: Ni, relative: ti.before, retry: Yi.tryDown, failure: zi.failedDown },
    ...
    wm = oa([{ domRange: ['rng'] }, { relative: ['startSitu', 'finishSitu'] }, { exact: ['start', 'soffset', 'finish', 'foffset'] }]),
    vm = {
      ...
      getWin: (e) => {
        const t = ((e) => e.match({ domRange: (e) => xe.fromDom(e.startContainer), relative: (e, t) => ti.getStart(e), exact: (e, t, o, n) => e }))(e)
    ...
    xm = (e, t) => {
      const o = ne(e)
      return 'input' === o ? ti.after(e) : D(['br', 'img'], o) ? (0 === t ? ti.before(e) : ti.after(e)) : ti.on(e, t)
    },
    ...
    km = (e) => {
      if (e.rangeCount > 0) {
        ...
        return C.some(fi(xe.fromDom(t.startContainer), t.startOffset, xe.fromDom(o.endContainer), o.endOffset))
      }
      return C.none()
    },
    Em = (e) => {
      ...
      situsFromPoint: (t, o) =>
        ((e, t, o) =>
          ((e, t, o) => {
            ...
            return ym(n, t, o).map((e) => fi(xe.fromDom(e.startContainer), e.startOffset, xe.fromDom(e.endContainer), e.endOffset))
    ...
    $m = (e) => {
      ...
      var s, l
      return ((e, t, o, n, r, s, l) => ({ target: e, x: t, y: o, stop: n, prevent: r, kill: s, raw: l }))(t, e.clientX, e.clientY, o, n, r, e)
    },
    Vm = (e, t, o, n) => {
    ...
    Ym = (e, t) => {
      const o = ((r = Ms.selectedSelector), { get: () => ks(xe.fromDom(e.getBody()), r).fold(() => Fs(os(e), es(e)).fold(Im, Hm), Fm) }),
        n = ((e, t, o) => {
          const n = (t) => {
                    ...
                    g = Rs(t, n.selectedSelector).fold(
                      ...
                      (e) => {
                        const o = (o) => () => {
                          const s = V(o, (o) =>
                            ((e, t, o, n, r) =>
                              Os(n, e, t, r.firstSelectedSelector, r.lastSelectedSelector).map((e) => (r.clearBeforeUpdate(o), r.selectRange(o, e.boxes, e.start, e.finish), e.boxes)))(
                              o.rows,
                              o.cols,
                              t,
                              e,
                          ...
                          return s.fold(
                            () =>
                              Ds(t, n.firstSelectedSelector, n.lastSelectedSelector).map((e) => {
                                ...
                                return r.setRelativeSelection(ti.on(e.first, 0), o(e.table)), n.clear(t), oi(C.none(), !0)
                              }),
                ...
                keyup: (e, r, s, l, a) =>
                  Rs(t, n.selectedSelector).fold(() => {
                    ...
                    return !0 === c.shiftKey && hm(i) && Lm(r, l)
                      ? ((e, t, o, n, r, s, l) => (Re(o, r) && n === s ? C.none() : wt(o, 'td,th', t).bind((o) => wt(r, 'td,th', t).bind((n) => bi(e, t, o, n, l)))))(t, o, r, s, l, a, n.selectRange)
                      : C.none()
                  }, C.none),
              }
            })(r, s, l, n),
    ...
    Qm = (e) => ({ registry: K(e, (e) => ({ bind: e.bind, unbind: e.unbind })), trigger: K(e, (e) => e.trigger) }),
    Xm = (e) => e.slice(0).sort(),
    Zm = (e, t) => {
      const o = _(t, (t) => !D(e, t))
      o.length > 0 &&
        ...
        ((e, t, o) => {
          ...
          return (
            ...
            (n) => {
              ...
              P(t, (e) => D(r, e)) ||
                ((e, t) => {
                  throw new Error('All required keys (' + Xm(e).join(', ') + ') were not specified. Specified keys were: ' + Xm(t).join(', ') + '.')
                })(t, r),
                e(t, r)
              ...
              return (
                s.length > 0 &&
                  ((e, t) => {
                    throw new Error('All values need to be of type: ' + t + '. Keys (' + Xm(e).join(', ') + ') were not.')
                  })(s, o.label),
                n
              )
            }
  ...
  const cd = sd('ephox-snooker').resolve,
    ...
    gd = (e, t, o, n, r) => {
      ...
      ;((e, t, o, n) => {
        fd(e, t, (e, t) => {
          const r = ((e, t, o, n, r) => {
            ...
            return Bt(s, { position: 'absolute', left: t + 'px', top: o - 3.5 + 'px', height: '7px', width: n + 'px' }), he(s, { 'data-row': e, role: 'presentation' }), s
      ...
      ;((e, t, o, n) => {
        fd(e, t, (e, t) => {
          const r = ((e, t, o, n, r) => {
            const s = xe.fromTag('div')
            return Bt(s, { position: 'absolute', left: t - 3.5 + 'px', top: o + 'px', height: r + 'px', width: '7px' }), he(s, { 'data-column': e, role: 'presentation' }), s
    ...
    yd = (e) => {
      ...
      const l = (n, r) => {
          d.trigger.startAdjust(), t.assign(n), ge(n, 'data-initial-' + r, Pt(n, r)), jm(n, vd), Nt(n, 'opacity', '0.2'), o.go(e.parent())
        },
        c = Um(e.parent(), 'mousedown', (e) => {
          var t
          ;(t = e.target), Pm(t, md) && l(e.target, 'top'), ((e) => Pm(e, dd))(e.target) && l(e.target, 'left')
        }),
        i = (t) => Re(t, e.view()),
        ...
        d = Qm({ adjustHeight: Jm(['table', 'delta', 'row']), adjustWidth: Jm(['table', 'delta', 'column']), startAdjust: Jm([]) })
      return {
        destroy: () => {
            ...
            e.inline
              ? ((e, t, o) => ({ parent: g(t), view: g(e), origin: g(bn(0, 0)), isResizable: o }))(
                  ...
                  (() => {
                    ...
                    return Bt(e, { position: 'static', height: '0', width: '0', padding: '0', margin: '0', border: '0' }), Ie(at(xe.fromDom(document)), e), e
                  })(),
                  t
                )
              : ((e, t) => {
          ...
          if (
            ...
            const n = ((e, t, o) => {
              const n = Bn,
                r = zn,
                s = yd(e),
                l = Qm({ beforeResize: Jm(['table', 'type']), afterResize: Jm(['table', 'type']), startDrag: Jm([]) })
              return (
                ...
                { on: s.on, off: s.off, refreshBars: s.refresh, hideBars: s.hideBars, showBars: s.showBars, destroy: s.destroy, events: l.registry }
              )
            })(r, i(), c)
            n.on(),
          ...
          const o = es(e),
            n = (t) =>
              Fs(os(e))
                ...
                .getOr('')
          G({ mceTableRowType: () => n(t.getTableRowType), mceTableCellType: () => n(t.getTableCellType), mceTableColType: () => n(t.getTableColType) }, (t, o) => e.addQueryValueHandler(o, t))
        })(e, n),
        $s(e, n),
