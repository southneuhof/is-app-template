  ...
  t.add('advlist', (t) => {
    t.hasPlugin('lists')
      ? (((t) => {
          ...
          e('advlist_number_styles', { processor: 'string[]', default: 'default,lower-alpha,lower-greek,lower-roman,upper-alpha,upper-roman'.split(',') }),
            e('advlist_bullet_styles', { processor: 'string[]', default: 'default,circle,square'.split(',') })
        })(t),
        ((t) => {
          m(t, 'numlist', 'Numbered list', 'InsertOrderedList', 'OL', r(t)), m(t, 'bullist', 'Bullet list', 'InsertUnorderedList', 'UL', n(t))
        })(t),
        ((t) => {
