        ...
        var t = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i,
          ...
          s = {
            ...
            highlightElement: function (t, n, a) {
              ...
              if (
                (s.hooks.run('before-sanity-check', l), (o = l.element.parentElement) && 'pre' === o.nodeName.toLowerCase() && !o.hasAttribute('tabindex') && o.setAttribute('tabindex', '0'), !l.code)
              )
      ...
      return (
        ...
        s.languages.insertBefore('javascript', 'keyword', {
          regex: {
            ...
            greedy: !0,
            inside: {
              'regex-source': { pattern: /^(\/)[\s\S]+(?=\/[a-z]*$)/, lookbehind: !0, alias: 'language-regex', inside: s.languages.regex },
              'regex-delimiter': /^\/|\/$/,
              'regex-flags': /^[a-z]+$/,
            },
          },
