...
import { buildSectionIncludeFromSchema, createNestedSectionFromSchemaData, createSectionFromSchema, } from '../schema.js';
...
describe('createNestedSectionFromSchemaData', () => {
    ...
    it('materializes nested section slots recursively', async () => {
        ...
        expect(prisma.section.create).toHaveBeenNthCalledWith(1, expect.objectContaining({
            data: expect.objectContaining({
                section_group_id: 'group1',
            }),
        }));
        expect(prisma.section.create).toHaveBeenNthCalledWith(2, expect.objectContaining({
            data: expect.objectContaining({
    ...
    it('throws clear errors for missing inputs and invalid nested context', async () => {
        ...
        await expect(createNestedSectionFromSchemaData({
