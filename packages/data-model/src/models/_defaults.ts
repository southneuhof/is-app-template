import { mergeModelConfig, type InputConfig, type ModelConfig } from '@southneuhof/is-data-model'
import { z } from 'zod'
...
export function withModelDefaults(model: ModelConfig): ModelConfig {
  return defineDataModel({
    base: mergeModelConfig(appModelDefaults, model),
  })
}
